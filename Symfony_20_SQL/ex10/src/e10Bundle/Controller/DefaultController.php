...
use App\e10Bundle\Entity\Person;
use App\e10Bundle\Entity\Address;
use App\e10Bundle\Entity\BankAccount;
use App\e10Bundle\Form\PersonType;
...
class DefaultController extends AbstractController {
	...
	#[Route('/e10', name:'e10_index', methods:['GET', 'POST'])]
	...
	public function indexAction(Request $request, EntityManagerInterface $entity) : Response {
		...
		if ($form->isSubmitted() && $form->isValid()) {
			try {
				...
				return $this->redirectToRoute('e10_index');
	...
	#[Route('/e10/delete/{id}', name: 'e10_delete', methods: ['POST'])]
	...
	#[Route('/e10/update/{id}', name: 'e10_update', methods: ['GET', 'POST'])]
