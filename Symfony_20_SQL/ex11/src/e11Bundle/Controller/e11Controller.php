...
namespace App\e11Bundle\Controller;
...
class e11Controller extends AbstractController {
	...
	#[Route('/e11', name:'e11_controller_index')]
	public function indexAction(Connection $connection, Request $request): Response {
		...
		if ($form->isSubmitted() && $form->isValid()) {
			...
			try {
				...
				return $this->redirectToRoute('e11_controller_index');
			} catch (\Exception $e) {
		...
		return $this->render('e11/index.html.twig', [
	...
	#[Route('/e11/create-table', name:'e11_create_table')]
	...
	// ajout d'une colonne
	#[Route('/e11/add-column', name:'e11_add_column')]
	...
	#[Route('/e11/create-relations', name:'e11_create_relations')]
	...
	#[Route('e11/delete/{id}', name:'e11_delete')]
	...
	#[Route('e11/update/{id}', name:'e11_update', methods: ['GET', 'POST'])]
	public function updateAction(Connection $connection, Request $request, int $id): Response {
		...
		return $this->render('e11/update.html.twig', [
			'form' => $form->createView()
		]);
	}
}