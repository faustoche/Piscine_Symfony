...
class DefaultController extends AbstractController {
    ...
    #[Route('/ex01/{article}', name: 'homepage', defaults: ['article' => 'main'])]
    ...
    function showPage(string $article) {
        ...
        $contentPage = '
            ...
            <ul>
                <li><a href="/ex01/gull">Les mouettes</a></li>
                <li><a href="/ex01/bear">Les ours</a></li>
                <li><a href="/ex01/dog">Les chiens</a></li>
            </ul>
        ';
        ...
        return $this->render('ex01/ex01.html.twig', [
            'content' => $contentPage
        ]);
    }
}